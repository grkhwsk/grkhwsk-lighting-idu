...
### Исходные данные
Все данные, использованные в эксперименте, размещены в папке ...
...
Коэффициенты K_time по сезонам и временным слотам для г. Норильска - k_time_norilsk.csv
Коэффициенты K_albedo по сезонам - k_albedo.csv
